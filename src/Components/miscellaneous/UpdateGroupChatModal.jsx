...
const UpdateGroupChatModal = ({ fetchAgain, setFetchAgain, fetchMessages }) => {
  ...
  const handleRemove = async (userToRemove) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://communi-cate.onrender.com/api/chat/removefromgroup`,
        {
  ...
  const handleAddUser = async (userToAdd) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://communi-cate.onrender.com/api/chat/addToGroup`,
        {
          chatId: selectedChat._id,
  ...
  const handleRename = async () => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://communi-cate.onrender.com/api/chat/rename`,
        {
          chatId: selectedChat._id,
  ...
  const handleSearch = async (query) => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `https://communi-cate.onrender.com/api/user?search=${query}`,
        config
      );
      setLoading(false);
